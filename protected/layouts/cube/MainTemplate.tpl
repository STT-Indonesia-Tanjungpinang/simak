            ...
            <div id="col-left-inner" class="col-left-nano-content">
              ...
              <div class="collapse navbar-collapse navbar-ex1-collapse" id="sidebar-nav">	
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <com:TLiteral Visible="<%=$this->Page->Pengguna->getTipeUser() == 'sa' && $this->Page->showSideBarMenu == true%>">
                    ...
                    <li<%=$this->Page->showSubMenuSettingSistem == true?' class="active"':''%>>
                      ...
                      <ul class="submenu">
                        ...
                        <li>
                          <a href="<%=$this->Page->constructUrl('settings.UserVN', true)%>"<%=$this->Page->showUserVN == true ? ' class="active" ':''%>>
                            User Verifikator Nilai
                          </a>
                        </li>
                        <li>
                          <a href="<%=$this->Page->constructUrl('settings.UserCN', true)%>"<%=$this->Page->showUserCN == true ? ' class="active" ':''%>>
                            User Checker Nilai
                          </a>
                        </li>
                        <li>                                                
                  ...
                  <com:TLiteral Visible="<%=$this->Page->Pengguna->getTipeUser() == 'vn' && $this->Page->showSideBarMenu == true%>">
                    <li<%=$this->Page->showDashboard == true?' class="active"':''%>>
                      <a href="<%=$this->Page->constructUrl('Home', true)%>">
                        <i class="fa fa-dashboard"></i>
                        <span>Dashboard</span>											
                  ...
                  <com:TLiteral Visible="<%=$this->Page->Pengguna->getTipeUser() == 'cn' && $this->Page->showSideBarMenu == true%>">
                    <li<%=$this->Page->showDashboard == true?' class="active"':''%>>
                      <a href="<%=$this->Page->constructUrl('Home', true)%>">
                        <i class="fa fa-dashboard"></i>
                        <span>Dashboard</span>											
