 ...
 * @since 3.1.3
 */
class TActiveCustomDatePicker extends TCustomDatePicker  implements ICallbackEventHandler, IActiveControl
{
	...
	/**
	 * @return TActiveCustomDatePickerClientScript javascript validator event options.
	 */
	protected function createClientScript()
	{
		return new TActiveCustomDatePickerClientScript;
	}
}

/**
 * TActiveCustomDatePickerClientScript class.
 *
 ...
 * @since 3.2.1
 */
class TActiveCustomDatePickerClientScript extends TCallbackClientSide
{
	/**
