...
class CPembagianKelas extends MainPageCN
{	
  public function onLoad($param) {
    ...
    {
      if (!isset($_SESSION['currentPagePembagianKelas']) || $_SESSION['currentPagePembagianKelas']['page_name'] != 'cn.perkuliahan.PembagianKelas') 
      {                
        $_SESSION['currentPagePembagianKelas'] = array('page_name' => 'cn.perkuliahan.PembagianKelas', 'page_num' => 0, 'search' => false,'nama_hari' => 'none');												
      }
      $kjur = $_SESSION['kjur'];	
