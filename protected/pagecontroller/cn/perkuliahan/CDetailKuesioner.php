...
class CDetailKuesioner extends MainPageCN {	
	...
	public function onLoad($param) {
		...
		if (!$this->IsPostBack && !$this->IsCallback) {	
            if (!isset($_SESSION['currentPageDetailKuesioner']) || $_SESSION['currentPageDetailKuesioner']['page_name'] != 'cn.perkuliahan.DetailKuesioner') {
				$_SESSION['currentPageDetailKuesioner'] = array('page_name' => 'cn.perkuliahan.DetailKuesioner', 'page_num' => 0,'DataKuesioner' =>array());
			}             
