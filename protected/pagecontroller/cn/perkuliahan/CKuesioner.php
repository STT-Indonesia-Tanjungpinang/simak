...
class CKuesioner extends MainPageCN {
  public function onLoad($param) {		
    ...
    if (!$this->IsPostBack && !$this->IsCallback) {
      if (!isset($_SESSION['currentPageKuesioner']) || $_SESSION['currentPageKuesioner']['page_name'] != 'cn.perkuliahan.Kuesioner') {
        $_SESSION['currentPageKuesioner'] = array('page_name' => 'cn.perkuliahan.Kuesioner', 'page_num' => 0, 'search' => false);
      }  
