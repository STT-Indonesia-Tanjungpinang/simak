...
class CPesertaKelas extends MainPageCN {	
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {
            if (!isset($_SESSION['currentPagePesertaKelas']) || $_SESSION['currentPagePesertaKelas']['page_name'] != 'cn.perkuliahan.PesertaKelas') {
				$_SESSION['currentPagePesertaKelas'] = array('page_name' => 'cn.perkuliahan.PesertaKelas', 'page_num' => 0, 'search' => false,'InfoKelas' =>array());
			}  
