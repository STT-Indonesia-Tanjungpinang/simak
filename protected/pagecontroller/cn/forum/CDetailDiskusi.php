...
class CDetailDiskusi extends MainPageCN {
    public $DataDiskusi;
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {              
            if (!isset($_SESSION['currentPageDetailDiskusi']) || $_SESSION['currentPageDetailDiskusi']['page_name'] != 'cn.forum.DetailDiskusi') {                                                                                
                $_SESSION['currentPageDetailDiskusi'] = array('page_name' => 'cn.forum.DetailDiskusi', 'page_num' => 0, 'search' => false,'DataDiskusi' =>array());
            }            
            try {
