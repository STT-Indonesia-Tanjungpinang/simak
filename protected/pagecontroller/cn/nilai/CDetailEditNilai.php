...
class CDetailEditNilai extends MainPageCN
{    
  public function onLoad($param) 
  {
    ...
    {
      if (!isset($_SESSION['currentPageDetailEditNilai']) || $_SESSION['currentPageDetailEditNilai']['page_name'] != 'cn.nilai.DetailEditNilai') {
        $_SESSION['currentPageDetailEditNilai'] = array('page_name' => 'cn.nilai.DetailEditNilai', 'page_num' => 0, 'search' => false,'DataNilai' =>array(), 'jumlahrecord' =>50);
      }  
