...
class CDPNA extends MainPageCN {
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {     
			if (!isset($_SESSION['currentPageDPNA']) || $_SESSION['currentPageDPNA']['page_name'] != 'cn.nilai.DPNA') {
                $_SESSION['currentPageDPNA'] = array('page_name' => 'cn.nilai.DPNA', 'page_num' => 0, 'search' => false,'DataDPNA' =>array());
			}      
