...
class CEditNilai extends MainPageCN 
{
  ...
  {		
    ...
    {
      if (!isset($_SESSION['currentPageEditNilai']) || $_SESSION['currentPageEditNilai']['page_name'] != 'cn.nilai.EditNilai') 
      {
        $_SESSION['currentPageEditNilai'] = array('page_name' => 'cn.nilai.EditNilai', 'page_num' => 0, 'search' => false);
      }  
