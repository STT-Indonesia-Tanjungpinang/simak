...
class CEvaluasiHasilBelajar extends MainPageCN {
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {
            if (!isset($_SESSION['currentPageEvaluasiHasilBelajar']) || $_SESSION['currentPageEvaluasiHasilBelajar']['page_name'] != 'cn.nilai.EvaluasiHasilBelajar') {
				$_SESSION['currentPageEvaluasiHasilBelajar'] = array('page_name' => 'cn.nilai.EvaluasiHasilBelajar', 'page_num' => 0, 'search' => false);
			}  
