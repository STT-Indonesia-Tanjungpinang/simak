...
class CDiskusi extends MainPageMHS {        
    ...
    public function populateUnread ($search=false) {
        if ($search) {  
            ...
            $str = "SELECT fp.idpost,fk.nama_kategori,fp.title,fp.content,fp.userid,fp.nama_user,fp.date_added FROM forumposts fp, forumkategori fk WHERE fp.idkategori=fk.idkategori AND parentpost=0 AND unread=1";
