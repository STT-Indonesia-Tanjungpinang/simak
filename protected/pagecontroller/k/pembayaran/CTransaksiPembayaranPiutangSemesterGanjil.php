...
class CTransaksiPembayaranPiutangSemesterGanjil Extends MainPageK {	
    ...
    public function getDataMHS($idx) {
        if (isset($_SESSION['currentPagePembayaranPiutangSemesterGanjil']['DataMHS'])){
...
{   
	...
	{	
        $this->createObj('Finance');
        $writer->write($this->Finance->toRupiah(CTransaksiPembayaranPiutangSemesterGanjil::$TotalKomponenBiaya));	
	}
}
...
{   
	...
	{	
        $this->createObj('Finance');
        $writer->write($this->Finance->toRupiah(CTransaksiPembayaranPiutangSemesterGanjil::$TotalSudahDibayarkan));	
	}
}
...
{   
	...
	{	
        $this->createObj('Finance');
        $writer->write($this->Finance->toRupiah(CTransaksiPembayaranPiutangSemesterGanjil::$TotalJumlahBayar));	
	}
}