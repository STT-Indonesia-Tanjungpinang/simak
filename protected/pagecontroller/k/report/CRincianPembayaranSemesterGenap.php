...
class CRincianPembayaranSemesterGenap Extends MainPageK {		
	public function onLoad($param) {
		parent::onLoad($param);				
        $this->showReport=true;
        $this->showReportRincianPembayaranGenap=true;                
	...
	public function populateData($search = false) {		
        ...
        $this->RepeaterS->CurrentPageIndex = $_SESSION['currentPageRincianPembayaranSemesterGenap']['page_num'];
	...
	public function printOut($sender, $param) {	
        ...
        switch($_SESSION['outputreport']) {
            ...
            case 'excel2007':
                ...
                $this->report->printRincianPembayaranSemester($this->Finance); 
            break;
            case 'pdf':
