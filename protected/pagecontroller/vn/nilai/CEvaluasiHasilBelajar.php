...
class CEvaluasiHasilBelajar extends MainPageVN {
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {
            if (!isset($_SESSION['currentPageEvaluasiHasilBelajar']) || $_SESSION['currentPageEvaluasiHasilBelajar']['page_name'] != 'vn.nilai.EvaluasiHasilBelajar') {
				$_SESSION['currentPageEvaluasiHasilBelajar'] = array('page_name' => 'vn.nilai.EvaluasiHasilBelajar', 'page_num' => 0, 'search' => false);
			}  
