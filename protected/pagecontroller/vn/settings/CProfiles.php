...
class CProfiles extends MainPageVN {    
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {	
            if (!isset($_SESSION['currentPageCache']) || $_SESSION['currentPageCache']['page_name'] != 'vn.settings.Profiles') {
				$_SESSION['currentPageCache'] = array('page_name' => 'vn.settings.Profiles', 'page_num' => 0);												
			}            
            $this->populateData();
		}
