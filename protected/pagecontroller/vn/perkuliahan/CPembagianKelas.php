...
class CPembagianKelas extends MainPageVN
{	
  public function onLoad($param) {
    ...
    {
      if (!isset($_SESSION['currentPagePembagianKelas']) || $_SESSION['currentPagePembagianKelas']['page_name'] != 'vn.perkuliahan.PembagianKelas') 
      {                
        $_SESSION['currentPagePembagianKelas'] = array('page_name' => 'vn.perkuliahan.PembagianKelas', 'page_num' => 0, 'search' => false,'nama_hari' => 'none');												
      }
      $kjur = $_SESSION['kjur'];	
