...
class CDetailDiskusi extends MainPageVN {
	...
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack && !$this->IsCallback) {              
            if (!isset($_SESSION['currentPageDetailDiskusi']) || $_SESSION['currentPageDetailDiskusi']['page_name'] != 'vn.forum.DetailDiskusi') {                                                                                
                $_SESSION['currentPageDetailDiskusi'] = array('page_name' => 'vn.forum.DetailDiskusi', 'page_num' => 0, 'search' => false,'DataDiskusi' =>array());
            }            
            try {
