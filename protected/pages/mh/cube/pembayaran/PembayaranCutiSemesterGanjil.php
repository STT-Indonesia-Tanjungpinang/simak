<?php
prado::using ('Application.pagecontroller.mh.pembayaran.CPembayaranCutiSemesterGanjil');
class PembayaranCutiSemesterGanjil Extends CPembayaranCutiSemesterGanjil {
