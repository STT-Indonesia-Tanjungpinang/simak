...
prado::using ('Application.pagecontroller.mh.pembayaran.CTransaksiPembayaranSemesterGenap');
class TransaksiPembayaranSemesterGenap Extends CTransaksiPembayaranSemesterGenap {		
    ...
    public function itemCreated($sender, $param){
        ...
        if($item->ItemType === 'Item' || $item->ItemType === 'AlternatingItem')  {            
            ...
            CTransaksiPembayaranSemesterGenap::$TotalKomponenBiaya+=$item->DataItem['biaya'];
            CTransaksiPembayaranSemesterGenap::$TotalJumlahBayar+=$item->DataItem['jumlah_bayar'];
        } 
