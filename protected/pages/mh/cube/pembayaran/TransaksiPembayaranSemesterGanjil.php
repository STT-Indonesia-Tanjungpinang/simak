...
prado::using ('Application.pagecontroller.mh.pembayaran.CTransaksiPembayaranSemesterGanjil');
class TransaksiPembayaranSemesterGanjil Extends CTransaksiPembayaranSemesterGanjil {		
    ...
    public function itemCreated($sender, $param){
        ...
        if($item->ItemType==='Item' || $item->ItemType==='AlternatingItem')  {            
            ...
            CTransaksiPembayaranSemesterGanjil::$TotalKomponenBiaya+=$item->DataItem['biaya'];
            CTransaksiPembayaranSemesterGanjil::$TotalJumlahBayar+=$item->DataItem['jumlah_bayar'];
        } 
