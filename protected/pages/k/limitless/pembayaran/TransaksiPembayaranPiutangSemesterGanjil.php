...
prado::using ('Application.pagecontroller.k.pembayaran.CTransaksiPembayaranPiutangSemesterGanjil');
class TransaksiPembayaranPiutangSemesterGanjil Extends CTransaksiPembayaranPiutangSemesterGanjil {		
    ...
    public function itemCreated($sender, $param){
        ...
        if($item->ItemType==='Item' || $item->ItemType==='AlternatingItem')  {            
            ...
            CTransaksiPembayaranPiutangSemesterGanjil::$TotalKomponenBiaya+=$item->DataItem['biaya'];
            CTransaksiPembayaranPiutangSemesterGanjil::$TotalJumlahBayar+=$item->DataItem['jumlah_bayar'];
        } 
