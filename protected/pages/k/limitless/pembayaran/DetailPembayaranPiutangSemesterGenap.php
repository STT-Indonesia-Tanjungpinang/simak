<?php
prado::using ('Application.pagecontroller.k.pembayaran.CDetailPembayaranPiutangSemesterGenap');
class DetailPembayaranPiutangSemesterGenap Extends CDetailPembayaranPiutangSemesterGenap {		
