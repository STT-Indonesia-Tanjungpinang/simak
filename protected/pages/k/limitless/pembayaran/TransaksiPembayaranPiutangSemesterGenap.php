...
prado::using ('Application.pagecontroller.k.pembayaran.CTransaksiPembayaranPiutangSemesterGenap');
class TransaksiPembayaranPiutangSemesterGenap Extends CTransaksiPembayaranPiutangSemesterGenap {		
    ...
    public function itemCreated($sender, $param){
        ...
        if($item->ItemType==='Item' || $item->ItemType==='AlternatingItem')  {            
            ...
            CTransaksiPembayaranPiutangSemesterGenap::$TotalKomponenBiaya+=$item->DataItem['biaya'];
            CTransaksiPembayaranPiutangSemesterGenap::$TotalJumlahBayar+=$item->DataItem['jumlah_bayar'];
        } 
