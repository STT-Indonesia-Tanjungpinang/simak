...
{  
  ...
  /**
   * digunakan untuk mendapatkan daftar channel marketing
   */
  public function getListChannelMarketing()
  {
    $dataitem=$this->getList ("channel_marketing", array('id_channel_marketing', 'nama_channel'), 'id_channel_marketing', null, 1);			
    $dataitem['none'] = 'Daftar Mengenal STTI';        
    return $dataitem;     		
  }
  /**
